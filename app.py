...
# --- PAGE CONFIGURATION ---
st.set_page_config(page_title="PneuSight Radiology", page_icon="🩻", layout="wide")
...
try:
    ...
    st.error("⚠️ Model initialization failed. Please check the download link in app.py")
    st.stop()
...
if uploaded_files and st.button("RUN PNEUSIGHT PROTOCOL"):
    ...
    for idx, uploaded_file in enumerate(uploaded_files):
        ...
        with col2:
            ...
            href = f'<a href="data:application/octet-stream;base64,{b64}" download="PneuSight_Report_{uploaded_file.name}.pdf" style="text-decoration:none;"><button style="background-color:#004d99;color:white;width:100%;padding:10px;border:none;border-radius:5px;cursor:pointer;">📄 Download Report</button></a>'
