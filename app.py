...
def make_gradcam_heatmap(img_array, model, last_conv_layer_name, pred_index=None):
    ...
    # 1. FIXED: Use model.input (singular) to avoid mismatch
    ...
    for idx, (file_source, filename) in enumerate(st.session_state.file_list):
        ...
        with col2:
            if is_valid:
                ...
                # --- NEW FEATURE: CONDITIONAL HEATMAP ---
                if score > 0.5:
                    ...
                    if show_heatmap:
                        if last_conv_layer:
                            ...
                            st.warning("Heatmap not available for this model architecture.")
                else:
